...
export default function FormX1() {
  ...
  return (
    ...
    >
      ...
      <div className="text-center text-sm text-gray-500 py-2 font-karla font-normal">
        {step === 0 ? (
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="space-y-2">
                <p className="text-[16px] leading-[24px] text-[#37404A80] font-normal">
                  Question {step + 1} <span className="text-red-500">*</span>
                </p>
                <h2 className="text-[24px] leading-[32px] text-[#37404A] font-normal">
                  {currentQuestion.title}
                </h2>
              </div>

              <div className="py-2">{currentQuestion.component}</div>
